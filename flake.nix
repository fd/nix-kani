        ...
        in
        {
          ...
          checks.crane-zerocopy-lib =
            let
              ...
              cargoArtifacts = craneLib.buildDepsOnly commonArgs;
            in
            self.lib.cargoKani (commonArgs // {
              inherit system craneLib cargoArtifacts;
            });
    ...
    // {
      lib.cargoKani =
        ...
        let
          ...
          args = builtins.removeAttrs originalArgs [
            "craneLib"
            "cargoKaniExtraArgs"
            "cargoExtraArgs"
            "system"
        ...
        craneLib.mkCargoDerivation (args // {
          inherit cargoArtifacts;
          pnameSuffix = "-kani";
          buildPhaseCargoCommand = "cargo kani ${cargoExtraArgs} ${cargoKaniExtraArgs}";
          nativeBuildInputs = [ self.packages.${system}.kani ];
          installPhase = ''
            mkdir -p $out
          '';
